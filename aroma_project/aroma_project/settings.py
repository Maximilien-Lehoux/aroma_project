"""
Django settings for aroma_project project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'aromaproject-maximilien.herokuapp.com']
...
ROOT_URLCONF = 'aroma_project.urls'
...
WSGI_APPLICATION = 'aroma_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'aroma_advice', # le nom de notre base de donnees creee precedemment
